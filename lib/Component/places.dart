...
class _PlacesState extends State<Places> {
  ...
  void getfooddData()async{
    Placeapi newclass= Placeapi();
    double lat = 22.5312768;
    double lng = 88.3458048;
    await newclass.getPlaceDataList(widget.lat,widget.long);
    setState(() {
      _loading = false;
...
//debugPrint(fivestarFoodList.toString());
  ...
  Widget buildImage(String image, int index, String title,String location,String rating,String ranking) =>
      GestureDetector(
        onTap: () {
            ...
            ClipRRect(
                ...
                child:CachedNetworkImage(
                  ...
                  errorWidget: (context, url, error) => Image.network(
                    "https://img.traveltriangle.com/blog/wp-content/uploads/2017/11/Indian-Museum.jpg", // Replace with your default image asset path
                    height: 150,
                    width: 150,
                    fit: BoxFit.cover,
                  ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title:const Center(child: Text("Attractions")),
      ),
        ...
        child: SafeArea(
          child: Column(
            children: [
              Container(
                ...
                child: Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        const Text("Attractions around you"),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: <Widget>[
                            const Text(
                      ...
                      children: [
                        ...
                        DefaultTextStyle(
                          ...
                          child: AnimatedTextKit(
                            animatedTexts: [
                              TypewriterAnimatedText('5 Star Attractions Around You ...'),
                              TypewriterAnimatedText('৫ Star Attractions Around You ...'),
                              TypewriterAnimatedText('५ Star Attractions Around You ...'),
                            ],
                            repeatForever: true,
                          ),
                        ),
              ...
              _loading ? Container(
                  height: 200,
                  child:const Center(child: CircularProgressIndicator())):CarouselSlider.builder(
                itemCount: fivestarFoodList.length,
                itemBuilder:
                    (BuildContext context, int index, int realIndex) {
                  String? res = fivestarFoodList[index].photo;
                  String? res1 = fivestarFoodList[index].name;
                  String? res2 = fivestarFoodList[index].location.toString();
                ...
                child: Row(
                  ...
                  children: [
                    DefaultTextStyle(
                      ...
                      child: AnimatedTextKit(
                        animatedTexts: [
                          TypewriterAnimatedText('Attractions Around You ...'),
                        ],
                        repeatForever: true,
                      ),
                    ),
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return Container(
                        ...
                        child: CardTitle(
                          ...
                          // cuisine: foodlist[index].cuisine,
                          ranking: foodlist[index].ranking ?? "Not Available",
                          rating:foodlist[index].rating??"Not Available",
                          imageUrl: foodlist[index].photo??"https://img.traveltriangle.com/blog/wp-content/uploads/2017/11/Indian-Museum.jpg",
...
class CardTitle extends StatelessWidget {
  String imageUrl, location,name,ranking,rating;
  List cuisine;
                  ...
                  ClipRRect(
                      ...
                      child: CachedNetworkImage(
                        ...
                        errorWidget: (context, url, error) => Image.network(
                          ...
                          "https://img.traveltriangle.com/blog/wp-content/uploads/2017/11/Indian-Museum.jpg",
                      ...
                      children: [
                                  ...
                                  child: Material(
                                    ...
                                    child: Container(
                                      // color: Colors.black,
                                        ...
                                        child: Text(cuisineItem["name"].toString())),
                                  ),
                                ),
                              )
                                  .toList(),
                        ...
                        Row(
                          children: [
                            ...
                            const Icon(Icons.star,color: Colors.redAccent,size: 15,),
