...
await newclass.getFoodDataList(lat.toString(),lng.toString());
setState(() {
  _loading = false;
                    ...
                    children: [
                      ...
                      DefaultTextStyle(
                        ...
                        child: AnimatedTextKit(
                          animatedTexts: [
                            TypewriterAnimatedText('5 Star Restaurant Around You ...'),
                            TypewriterAnimatedText('৫ Star Restaurant Around You ...'),
                            TypewriterAnimatedText('५ Star Restaurant Around You ...'),
                          ],
                          repeatForever: true,
                        ),
                      ),
                ...
                itemBuilder: (BuildContext context, int index) {
                  return Container(
                    ...
                    child: CardTitle(
                      ...
                      imageUrl: foodlist[index].photo??"https://images.unsplash.com/photo-1600891964599-f61ba0e24092?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80",
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Icon(Icons.star,color: Colors.redAccent,size: 15,),
                          SizedBox(width: 9,),
