...
class Placeapi {
  ...
  Future<void> getPlaceDataList(lat, lng) async {
    try {
      // Define your RapidAPI key and API endpoint URL
      const apiKey = '621f84515fmsh8f2eb5cfbd49899p1d3690jsn6dec2261face';
      const apiUrl =
          'https://travel-advisor.p.rapidapi.com/attractions/list-by-latlng'; // Replace with the API endpoint URL.
      ...
      jsonData["data"].forEach((element){
        ...
        if(element["name"]!=null && element["address"]!=null) {
          ...
          foodModel foodmodel = foodModel(
            ...
            // cuisine: element['cuisine'],
              location : element["address"].length < 50
          ? element["address"]
              : element["address"].substring(0, 50),
